 ...
 *
 *   - :c:enumerator:`NOTMUCH_STATUS_PATH_ERROR`: An error occurred
 ...
 *
 * For errors other then :c:enumerator:`NOTMUCH_STATUS_NO_DATABASE`
 * and :c:enumerator:`NOTMUCH_STATUS_NO_CONFIG`, ``*database`` is set
 * to NULL.
 *
 * :return:
 *
 ...
 * if they have the same database UUID. The string 'uuid' is owned by
 * notmuch and should not be freed or modified by the user.
 */
unsigned long
